...
window.addEventListener('load', () => {
  ...
  if (document.referrer.includes('blog.html')) {
    ...
    toast.textContent = 'You are now reading the full story';
    toast.style.cssText = 'position: fixed; bottom: 20px; right: 20px; background: #C9A581; color: #fff; padding: 10px 20px; border-radius: 6px; z-index: 999';
